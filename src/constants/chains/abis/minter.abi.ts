export const minterAbi = [
  ...
  { inputs: [], name: 'AlreadyNudged', type: 'error' },
  { inputs: [], name: 'InvalidParams', type: 'error' },
  { inputs: [], name: 'NotEpochGovernor', type: 'error' },
  { inputs: [], name: 'NotPendingTeam', type: 'error' },
  { inputs: [], name: 'NotTeam', type: 'error' },
  { inputs: [], name: 'RateTooHigh', type: 'error' },
  { inputs: [], name: 'TailEmissionsInactive', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bool', name: '_tail', type: 'bool' },
    ],
    name: 'Mint',
    type: 'event',
  },
  ...
  },
  {
    inputs: [],
    name: 'aero',
    outputs: [{ internalType: 'contract IAero', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: '_growth', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'updatePeriod',
    outputs: [{ internalType: 'uint256', name: '_period', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
