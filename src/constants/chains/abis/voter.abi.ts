export const voterAbi = [
  ...
  { inputs: [], name: 'AlreadyVotedOrDeposited', type: 'error' },
  { inputs: [], name: 'DistributeWindow', type: 'error' },
  { inputs: [], name: 'FactoryPathNotApproved', type: 'error' },
  { inputs: [], name: 'GaugeAlreadyKilled', type: 'error' },
  { inputs: [], name: 'GaugeAlreadyRevived', type: 'error' },
  {
    inputs: [{ internalType: 'address', name: '_pool', type: 'address' }],
    name: 'GaugeDoesNotExist',
    type: 'error',
  },
  { inputs: [], name: 'GaugeExists', type: 'error' },
  {
    inputs: [{ internalType: 'address', name: '_gauge', type: 'address' }],
    name: 'GaugeNotAlive',
    type: 'error',
  },
  { inputs: [], name: 'InactiveManagedNFT', type: 'error' },
  { inputs: [], name: 'MaximumVotingNumberTooLow', type: 'error' },
  { inputs: [], name: 'NonZeroVotes', type: 'error' },
  { inputs: [], name: 'NotAPool', type: 'error' },
  ...
  { inputs: [], name: 'NotWhitelistedNFT', type: 'error' },
  { inputs: [], name: 'NotWhitelistedToken', type: 'error' },
  { inputs: [], name: 'SameValue', type: 'error' },
  { inputs: [], name: 'SpecialVotingWindow', type: 'error' },
  { inputs: [], name: 'TooManyPools', type: 'error' },
  { inputs: [], name: 'UnequalLengths', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bool', name: '_bool', type: 'bool' },
    ],
    name: 'WhitelistNFT',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_finish', type: 'uint256' },
    ],
    name: 'distribute',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_epochGovernor', type: 'address' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_maxVotingNum', type: 'uint256' },
    ],
