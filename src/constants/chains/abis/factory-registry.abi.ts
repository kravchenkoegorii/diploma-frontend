export const factoryRegistryAbi = [
  ...
  { inputs: [], name: 'FallbackFactory', type: 'error' },
  { inputs: [], name: 'InvalidFactoriesToPoolFactory', type: 'error' },
  { inputs: [], name: 'PathAlreadyApproved', type: 'error' },
  { inputs: [], name: 'PathNotApproved', type: 'error' },
