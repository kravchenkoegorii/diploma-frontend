...
export const almAbi = [
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'int24', name: 'tickNeighborhood', type: 'int24' },
      ...
      },
      {
        components: [
          ...
          { internalType: 'int24', name: 'maxAllowedDelta', type: 'int24' },
        ],
        indexed: false,
  ...
  },
  {
    ...
    name: 'ammModule',
    outputs: [
      { internalType: 'contract IVeloAmmModule', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
    name: 'earned',
    outputs: [{ internalType: 'uint256', name: 'earned_', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'initialTotalSupply', type: 'uint256' },
      { internalType: 'uint256', name: 'totalSupplyLimit_', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'slippageD9', type: 'uint32' }],
    name: 'setSlippageD9',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newTotalSupplyLimit', type: 'uint256' },
    ],
